                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="data_kamar.php">Kamar</a>
                                <a class="dropdown-item" href="data_pelanggan.php">Pelanggan</a>
                                <a class="dropdown-item" href="data_admin.php">Admin</a>
                                <a class="dropdown-item" href="data_pemesanan.php">pemesanan</a>
                            </div>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost:8081/Hotel_Wilson/baru_wilson/">Hotel Wilson</a>
                        </li>
                        <li class="nav-item">

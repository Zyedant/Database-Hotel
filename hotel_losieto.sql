...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Des 2023 pada 15.36
...
INSERT INTO `kamar` (`id_kamar`, `jenis_kamar`, `fasilitas`, `harga`, `tersedia`, `gambar_kamar`) VALUES
(1, 'VIP', 'banyak ', 150.00, 0, '');
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama`, `email`, `password`, `telepon`) VALUES
(10, 'adit', 'adiitgaming@gmail.com', 'adit', '08967543');
...
INSERT INTO `pemesanan` (`id_pemesanan`, `id_pelanggan`, `id_kamar`, `tanggal_checkin`, `tanggal_checkout`) VALUES
(1, 10, 1, '0000-00-00', '0000-00-00');
